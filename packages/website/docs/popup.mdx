...
import * as stories from 'website/src/examples/popup.stories.tsx';
...
你可以通过 `wrapperStyle={{ '--aro-popup-arrow-color': '#333' }}` 来设置弹层箭头的颜色。
...
<span
  // span.aro-popup-target 将匹配以下样式： display=inline-block
